...
myFirstSnippet =  s( "myFirstSnippet", fmt( "Hello {}. How are you {}?", { i(1, "Aditya"), rep(1) }))
table.insert(snippets, myFirstSnippet)

mySecondSnippet =  s( "mySecondSnippet", fmt( "Hello {}. How are you {}?", { c(1, {t"Aditya", t"Dutta"}), rep(1) }))
